...
void nearestGoalLeftFast() {
    ...
    dt.driveFor(vex::directionType::fwd, 30, vex::distanceUnits::in, 50, vex::velocityUnits::pct, true);
}
...
int main() {
    ...
    Competition.autonomous(nearestGoalLeftFast); //Change THIS to switch the autonomous program we are using!!!!!!
