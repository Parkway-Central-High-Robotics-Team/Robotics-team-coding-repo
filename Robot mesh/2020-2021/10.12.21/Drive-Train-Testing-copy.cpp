...
void autonomous() {
    ...
    dt.driveFor(vex::directionType::fwd, 50, vex::distanceUnits::in, 50, vex::velocityUnits::pct, true);
...
void drivercontrol() {
    ...
    while (true) {
        ...
        right_drive_mtr.spin(vex::directionType::rev, right_power, vex::velocityUnits::pct);
