...
void nearestGoalRightFast() {
    ...
    dt.driveFor(vex::directionType::fwd, 10, vex::distanceUnits::in, 60, vex::velocityUnits::pct, true);
    dt.driveFor(vex::directionType::fwd, 12, vex::distanceUnits::in, 30, vex::velocityUnits::pct, true);
...
void skills() {
    ...
    lift_mtr.spin(directionType::fwd, 40, vex::velocityUnits::pct);
    sleepMs(2000);
    lift_mtr.stop(brakeType::hold);
    ...
    dt.driveFor(vex::directionType::fwd, 17, vex::distanceUnits::in, 50, vex::velocityUnits::pct, true);
...
int main() {
    ...
    Competition.autonomous(skills); //Change THIS to switch the autonomous program we are using!!!!!!
