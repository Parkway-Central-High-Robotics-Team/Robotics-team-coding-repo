...
void drivercontrol() {
    ...
    while (true) {
        ...
        float left_bogus = con.Axis1.value();
        float right_bogus = con.Axis4.value();
        
        motor_1.spin(vex::directionType::fwd, left_bogus, vex::velocityUnits::pct);
        motor_2.spin(vex::directionType::fwd, right_bogus, vex::velocityUnits::pct);
