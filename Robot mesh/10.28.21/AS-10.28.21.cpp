...
void conveyor_lift_R1_button_press() {
    ...
    while(true) {
        if (con.ButtonR1.pressing() && conveyor_run_up == false) {
            conveyor_run_up = true;
            Brain.Screen.print("This works 2");
            wait(500,timeUnits::msec);
            
        }else if (con.ButtonR1.pressing() && conveyor_run_up == true) {
            conveyor_run_up = false;
            Brain.Screen.print("This works 3");
            wait(500,timeUnits::msec);
        }
    }
}
...
void conveyor_lift_R2_button_press() {
    Brain.Screen.print("This works 1");
    while(true) {
        if (con.ButtonR2.pressing() && conveyor_run_down == false) {
            conveyor_run_down = true;
            Brain.Screen.print("This works 2");
            wait(500,timeUnits::msec);
            
        }else if (con.ButtonR2.pressing() && conveyor_run_down == true) {
...
int main() {
    ...
    thread m_lift_thread_up = thread(lift_thread_up);
